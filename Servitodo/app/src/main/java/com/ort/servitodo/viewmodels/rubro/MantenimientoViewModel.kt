...
import com.ort.servitodo.fragments.rubro.MantenimientoFragmentArgs
...
class MantenimientoViewModel : ViewModel() {
    ...
    fun validacion(precioConsulta : String){
        if(!precioConsulta.isNullOrEmpty()){
            val rubro : Rubro = Mantenimiento(Integer.parseInt(precioConsulta), idRubro, "Mantenimiento")
